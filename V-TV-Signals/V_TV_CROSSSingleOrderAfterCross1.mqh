...
//    // if(candleLength > 15000 || candleLength2 > 15000)
//    {


      
// if(prefix=="TB" && (isBearish || isBearish2  || candleLength > 20000 || candleLength2 > 10000))
// {  
//        return EMPTY_VALUE;
// } else if(prefix=="TS" && (isBullish || isBullish2  || candleLength > 20000 || candleLength2 > 10000))
// {
//        return EMPTY_VALUE;
