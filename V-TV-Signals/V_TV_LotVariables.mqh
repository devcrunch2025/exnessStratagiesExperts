...
input int SeqSellMinSecsBetweenOrders = 60*2; // SELL: min seconds between orders seconds
input int SeqBuyMinSecsBetweenOrders  = 60*2; // BUY:  min seconds between orders seconds
